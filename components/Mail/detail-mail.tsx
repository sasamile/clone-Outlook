...
import { useMailStore, useNewMailStore } from "@/hooks/new-mail-state";
  ...
  return (
    <div className="flex flex-col">
      <div className="p-6">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-80">
                      <div className="space-y-2">
                        <h4 className="font-medium">Destinatarios adicionales</h4>
        ...
        <div
          className="text-gray-50 leading-relaxed prose prose-invert max-w-none space-y-3 text-xl pt-4"
